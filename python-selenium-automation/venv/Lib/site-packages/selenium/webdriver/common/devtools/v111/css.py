...
class RuleUsage:
    ...
    #: Indicates whether the rule was actually used by some element in the pages.
    used: bool
...
def disable() -> typing.Generator[T_JSON_DICT,T_JSON_DICT,None]:
    '''
    Disables the CSS agent for the given pages.
    '''
    cmd_dict: T_JSON_DICT = {
        'method': 'CSS.disable',
    }
...
def enable() -> typing.Generator[T_JSON_DICT,T_JSON_DICT,None]:
    '''
    Enables the CSS agent for the given pages. Clients should not assume that the CSS agent has been
