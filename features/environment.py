...
def browser_init(context):
    ...
    service = Service(executable_path=r'C:\Users\brown\CureskinProject\chromedriver.exe')
    context.driver = webdriver.Chrome(service=service)
    context.driver.maximize_window()
    #driver = webdriver.Chrome(service=service)

    #driver = webdriver.Chrome(service=Service(ChromeDriverManager(version='117.0.5938.92'),options=option))
    ...
    context.driver.wait = WebDriverWait(context, 4)
