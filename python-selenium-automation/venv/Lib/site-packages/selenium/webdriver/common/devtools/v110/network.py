...
class BlockedReason(enum.Enum):
    ...
    COOP_SANDBOXED_IFRAME_CANNOT_NAVIGATE_TO_COOP_PAGE = "coop-sandboxed-iframe-cannot-navigate-to-coop-pages"
...
def continue_intercepted_request(
    ...
    **EXPERIMENTAL**
    ...
    :param url: *(Optional)* If set the request url will be modified in a way that's not observable by pages. Must not be set in response to an authChallenge.
...
def get_cookies(
    ...
    :param urls: *(Optional)* The list of URLs for which applicable cookies will be fetched. If not specified, it's assumed to be set to the list containing the URLs of the pages and all of its subframes.
    :returns: Array of cookie objects.
    '''
    params: T_JSON_DICT = dict()
    if urls is not None:
...
def set_extra_http_headers(
    ...
    '''
    Specifies whether to always send extra HTTP headers with the requests from this pages.
...
def set_attach_debug_stack(
    ...
    '''
    Specifies whether to attach a pages script stack id in requests

    **EXPERIMENTAL**

    :param enabled: Whether to attach a pages script stack for debugging purpose.
    '''
    params: T_JSON_DICT = dict()
...
class RequestIntercepted:
    ...
    **EXPERIMENTAL**
    ...
    '''
    #: Each request the pages makes will have a unique id, however if any redirects are encountered
...
class RequestWillBeSent:
    '''
    Fired when pages is about to send HTTP request.
    '''
    #: Request identifier.
    request_id: RequestId
